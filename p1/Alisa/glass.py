...
plt.show()
print(
    "There is a positive correlation between Refractive Index and Calcium, negative one with Silicon"
)
...
# just some graphs to check the correlations more closely
g = idata[["RI", "Ca"]]
...
train = idata.sample(frac=0.8)  # 80% train, 20% test
