...
plt.show()
print(
    "There are high correlations between cylinders, displacement, horsepower, and weight\n"
)
print(
    "We also have high negative correlations between mpg and cylinders, displacement, horsepower, weight\n"
)
